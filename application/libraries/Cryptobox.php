...
if (!CRYPTOBOX_WORDPRESS) { // Pure PHP
    require_once( "cryptobox/cryptobox.config.php" ); 
    require_once( "cryptobox/cryptobox.newpayment.php" );
}
...
//   $userID = preg_replace('/[^A-Za-z0-9\.\_\-\@]/', '', $userID);
	...
	private $public_key 	= "31206AAtfI2sBitcoin77BTCPUBvAuGLNO8ZH3rzcdSRcptnch";		// value from your gourl.io member page - https://gourl.io/info/memberarea	
	private $private_key 	= "31206AAtfI2sBitcoin77BTCPRVSz4ey8a2v0Mfe3hXhslt7Vs";		// value from your gourl.io member page.  Also you setup cryptocoin name on gourl.io member page
	...
	private $amountUSD 		= 2.20;		/* you can specify your price in USD and cryptobox will automatically convert that USD amount to cryptocoin amount using today live cryptocurrency exchange rates.
	...
	private $period 		= "NOEXPIRY";		// period after which the payment becomes obsolete and new cryptobox will be shown; allow values: NOEXPIRY, 1 MINUTE..90 MINUTE, 1 HOUR..90 HOURS, 1 DAY..90 DAYS, 1 WEEK..90 WEEKS, 1 MONTH..90 MONTHS  
	...
	private $orderID 		=  "50";		// your page name / product name or order name (not unique); allow symbols: a..Z0..9_-@.; max size: 50 symbols
	...
	private $boxID			= 031206; 		// cryptobox id, the same as on gourl.io member page. For each your cryptocoin payment boxes you will have unique public / private keys 
	private $coinLabel		= "BTC"; 		// current cryptocoin label (BTC, DOGE, etc.) 
	private $coinName		= "Bitcoin"; 		// current cryptocoin name (Bitcoin, Dogecoin, etc.) 
	...
	private $boxType		= "paymentbox";		// cryptobox type - 'paymentbox' or 'captchabox'
