                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                          <h3><i class="fa fa-building-o"></i> LECTURER</h3>
                                        <span>view added Lecturers for your school</span>
                                    </div>                                    
                                ...
                                <div class="panel panel-default">
                                <div class="panel-heading">
                  <h3 class="panel-title"><a href="<?php echo site_url('admin/users/reglecturer');?>" class="btn btn-success btn-sm btn-flat btn-rounded "><i class="fa fa-plus"></i> Add New Lecturer?</a></h3> </div>
