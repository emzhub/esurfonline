...
$config['tables']['profiles']        = 'profile';
$config['tables']['admins']       	= 'es_admin';
$config['tables']['students']       = 'es_students';
$config['tables']['lecturer']       = 'es_lecturer';
$config['tables']['hod']     		= 'es_hod';
$config['tables']['lib']       = 'es_librarian';
$config['tables']['src']     		= 'es_src';
/*
 ...
 */
$config['site_title']                 = "esurfonline.com";       // Site Title, example.com
$config['admin_email']                = "info@esurfonline.com"; //chisomokoye@chisomokoye.com // admin@esurfonline.com //  info@esurfonline.com Admin Email, admin@example.com
$config['lib_group']              = 'librarian';           // Default  student group, use name
$config['src_group']              = 'src';           // Default  student group, use name
$config['student_group']              = 'student';           // Default  student group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['hod_group']                = 'hod';             // Default hod group, use name
$config['lecturer_group']             = 'lecturer';             // Default lecturer group, use name
	...
	'mailtype' => 'html',
		'protocol' => 'ssl',
			'smtp_host' => 'smtp.gmail.com',
				'smtp_port' => '465',
					'smtp_user' => 'kenneyg50@gmail.com',
						'smtp_pass' => 'Rooneywwe@111111',
							'charset' => 'utf8',
							'smtp_timeout' => '30',
);
