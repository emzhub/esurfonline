      ...
      $params = array();
        ...
        if ($total_records > 0)
        {
            ...
            $config['reuse_query_string'] = TRUE;
               ...
               $config['full_tag_open'] = '  <nav class="d-flex justify-content-center mt-5">
            ...
            $config['next_tag_open'] = ' <li class="page-item"><a class="page-link" aria-label="Next"><span aria-hidden="true">&raquo;</span><span class="sr-only">';
